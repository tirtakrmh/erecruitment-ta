...
import static com.tirta.main.MainSystemHRD.refreshFrom;
...
public class MainSystemManager extends javax.swing.JFrame {
    ...
    public MainSystemManager(ModelUserLogin user) {
        this.user = user;
        initComponents();
        ...
        drawer = Drawer.newDrawer(this)
                ...
                .addChild(new DrawerItem("Profil")
                        ...
                        .build())
                .addChild(new DrawerItem("Tentang Karyawan")
                        .foreGround(Color.white)
                        .font(font)
                        .icon(new ImageIcon(getClass().getResource("/com/tirta/icon/karyawan.png")))
                        .build())
                .addChild(new DrawerItem("Informasi LoKer")
                        .foreGround(Color.white)
                        .font(font)
                    ...
                    public void selected(int index, DrawerItem item) {
                        ...
                        switch (index) {
                             case 0:
                                ...
                                break;
                            case 1:
                                refreshFrom(new MenuTentangKaryawan(user.getId()));
                                break;
                            case 2:
