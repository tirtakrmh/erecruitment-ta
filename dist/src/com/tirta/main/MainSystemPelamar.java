...
public class MainSystemPelamar extends javax.swing.JFrame {
    ...
    public MainSystemPelamar(ModelUserLogin user) {
        this.user = user;
        initComponents();
        ...
        drawer = Drawer.newDrawer(this)
                ...
                .addChild(new DrawerItem("Profil")
                        ...
                        .build())
                .addChild(new DrawerItem("Lowongan Pekerjaan")
                        .foreGround(Color.white)
                        .font(font)
                        .icon(new ImageIcon(getClass().getResource("/com/tirta/icon/loker.png")))
                        .build())
                .addChild(new DrawerItem("Pemberitahuan")
                        .foreGround(Color.white)
                        .font(font)
                ...
                .event(new EventDrawer(){
                    ...
                    public void selected(int index, DrawerItem item) {
                        ...
                        switch (index) {
                            case 0:
                                refreshFrom(new MenuProfilPelamar(user.getId()));
                                break;
                            case 1:
                                refreshFrom(new MenuLowonganPekerjaan(user.getId()));
                                break;
                            case 2:
                                refreshFrom(new MenuPemberitahuanPelamar(user.getId()));
                                break;
                            case 3:
                                dispose();
