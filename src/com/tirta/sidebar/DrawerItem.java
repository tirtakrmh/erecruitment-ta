...
public class DrawerItem extends JButton {
    ...
    private float alpha;
    private int round;
    private Color effectColor = new Color(230, 230, 230);
    private int index;
    ...
    public DrawerItem effectColor(Color effectColor) {
        this.effectColor = effectColor;
        return this;
    }

    public DrawerItem borderInset(Insets borderInset) {
        this.borderInset = borderInset;
        return this;
    }

    public DrawerItem icon(Icon icon) {
        this.icon = icon;
        return this;
    }

    public DrawerItem iconTextGap(int iconTextGap) {
    ...
    public DrawerItem foreGround(Color fg) {
        this.foreGround = fg;
        return this;
    }
